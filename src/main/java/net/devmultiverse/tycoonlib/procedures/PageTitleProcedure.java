...
public class PageTitleProcedure {
	public static String execute(LevelAccessor world, double x, double y, double z) {
		if (!(TycoonlibModItems.RESTAURANT_BOARD_HOVER.get() == (new Object() {
			...
			if (Blocks.AIR.asItem() == (new Object() {
				...
				return "Room " + new java.text.DecimalFormat("#").format(new Object() {
					public double getValue(LevelAccessor world, BlockPos pos, String tag) {
						BlockEntity blockEntity = world.getBlockEntity(pos);
						if (blockEntity != null)
							return blockEntity.getPersistentData().getDouble(tag);
				...
				}.getValue(world, BlockPos.containing(x, y, z), "page") + 1) + ": None";
			}
			return "Room " + new java.text.DecimalFormat("#").format(new Object() {
				public double getValue(LevelAccessor world, BlockPos pos, String tag) {
					BlockEntity blockEntity = world.getBlockEntity(pos);
		...
		}.getValue(world, BlockPos.containing(x, y, z), "page") + 1) + ": Locked";
	}
}
