		...
		if (("GetEntryPass").equals(entity.getPersistentData().getString("CurrentTask"))) {
			...
			if (("True").equals(GetBlockData.substring((int) GetBlockData.indexOf("T") + "T".length(), (int) GetBlockData.lastIndexOf("T")))) {
				...
				if (2 > new Vec3(x, y, z).distanceTo(new Vec3((ConvertStringToNumberProcedure.execute(GetBlockData.substring((int) GetBlockData.indexOf("X") + "X".length(), (int) GetBlockData.lastIndexOf("X"))) + 0.5),
					...
					{
						Entity _ent = entity;
						_ent.teleportTo((entity.getPersistentData().getDouble("chairPositionX")), (entity.getPersistentData().getDouble("chairPositionY")), (entity.getPersistentData().getDouble("chairPositionZ")));
						if (_ent instanceof ServerPlayer _serverPlayer)
							_serverPlayer.connection.teleport((entity.getPersistentData().getDouble("chairPositionX")), (entity.getPersistentData().getDouble("chairPositionY")), (entity.getPersistentData().getDouble("chairPositionZ")),
			...
			if (entity.getPersistentData().getBoolean("InChair")) {
				{
					...
					_ent.teleportTo((entity.getPersistentData().getDouble("chairPositionX")), (entity.getPersistentData().getDouble("chairPositionY")), (entity.getPersistentData().getDouble("chairPositionZ")));
					if (_ent instanceof ServerPlayer _serverPlayer)
						_serverPlayer.connection.teleport((entity.getPersistentData().getDouble("chairPositionX")), (entity.getPersistentData().getDouble("chairPositionY")), (entity.getPersistentData().getDouble("chairPositionZ")), _ent.getYRot(),
								_ent.getXRot());
				}
			}
		}
