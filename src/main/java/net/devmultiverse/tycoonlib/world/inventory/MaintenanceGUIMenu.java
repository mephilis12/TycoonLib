...
public class MaintenanceGUIMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public MaintenanceGUIMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(TycoonlibModMenus.MAINTENANCE_GUI.get(), id);
