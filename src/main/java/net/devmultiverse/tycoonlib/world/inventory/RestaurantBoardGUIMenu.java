...
public class RestaurantBoardGUIMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public RestaurantBoardGUIMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
