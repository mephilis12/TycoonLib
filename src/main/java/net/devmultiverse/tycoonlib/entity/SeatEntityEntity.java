...
import net.devmultiverse.tycoonlib.procedures.SeatEntityTickProcedure;
import net.devmultiverse.tycoonlib.init.TycoonlibModEntities;

public class SeatEntityEntity extends PathfinderMob {
	public SeatEntityEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(TycoonlibModEntities.SEAT_ENTITY.get(), world);
	}
