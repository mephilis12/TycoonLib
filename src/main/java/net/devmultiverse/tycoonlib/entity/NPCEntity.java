...
import net.devmultiverse.tycoonlib.procedures.NPCTickUpdateProcedure;
...
public class NPCEntity extends PathfinderMob implements GeoEntity {
	public static final EntityDataAccessor<Boolean> SHOOT = SynchedEntityData.defineId(NPCEntity.class, EntityDataSerializers.BOOLEAN);
	public static final EntityDataAccessor<String> ANIMATION = SynchedEntityData.defineId(NPCEntity.class, EntityDataSerializers.STRING);
	...
	public NPCEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(TycoonlibModEntities.NPC.get(), world);
	}
	...
	protected void defineSynchedData() {
		...
		this.entityData.define(TEXTURE, "vassilisdoragokami");
	}
	...
	public void baseTick() {
		super.baseTick();
		NPCTickUpdateProcedure.execute(this.level(), this.getX(), this.getY(), this.getZ(), this);
	...
	protected void tickDeath() {
		...
		if (this.deathTime == 20) {
			this.remove(NPCEntity.RemovalReason.KILLED);
			this.dropExperience();
		}
	}
