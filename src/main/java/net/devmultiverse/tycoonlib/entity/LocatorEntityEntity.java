...
public class LocatorEntityEntity extends PathfinderMob {
	public LocatorEntityEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(TycoonlibModEntities.LOCATOR_ENTITY.get(), world);
	}
	...
	public SoundEvent getAmbientSound() {
		return ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("tycoonlib:silence"));
	}

	@Override
	public void playStepSound(BlockPos pos, BlockState blockIn) {
		this.playSound(ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("tycoonlib:silence")), 0.15f, 1);
	}
