package net.devmultiverse.tycoonlib.client.model;
...
public class Modela<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("tycoonlib", "modela"), "main");
